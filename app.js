...
(function () {
  ...
  const ENEMIES = {
    ...
    // ===== ENEMY BATCH II — extra foes per biome (reuse traits; cryptooze/magmaslime use the new 'slime' model) =====
    bonearcher:  { name: 'Bone Archer',  glyph: '⤙', color: '#e8e2cf', hp: 20, dmg: 8,  speed: 2.0, range: 4.5, attackKind: 'ranged-soul', xp: 11, goldRange: [2, 5], trait: null,      shape: 'skeleton', projColor: '#e8e2cf' },
    cryptooze:   { name: 'Crypt Ooze',   glyph: '◞', color: '#9bbf95', hp: 34, dmg: 7,  speed: 1.5, range: 1.1, attackKind: 'melee',       xp: 12, goldRange: [2, 6], trait: null,      shape: 'slime' },
    mossstalker: { name: 'Moss Stalker', glyph: 'ꙮ', color: '#6fae5a', hp: 30, dmg: 9,  speed: 3.0, range: 1.0, attackKind: 'melee',       xp: 13, goldRange: [3, 6], trait: 'pack',     shape: 'beast' },
    sporepod:    { name: 'Spore Pod',    glyph: '✺', color: '#b6e060', hp: 16, dmg: 7,  speed: 3.0, range: 4.0, attackKind: 'ranged-soul', xp: 12, goldRange: [3, 6], trait: 'erratic',  shape: 'orb',   projColor: '#b6e060' },
    rimecrawler: { name: 'Rime Crawler', glyph: '✶', color: '#bcd9ee', hp: 24, dmg: 9,  speed: 3.4, range: 1.0, attackKind: 'melee',       xp: 13, goldRange: [3, 6], trait: 'swarm',    shape: 'spider' },
    frostshade:  { name: 'Frost Shade',  glyph: '∽', color: '#cfeaff', hp: 22, dmg: 10, speed: 2.2, range: 4.5, attackKind: 'ranged-soul', xp: 15, goldRange: [4, 7], trait: 'phase',    shape: 'ghost', projColor: '#cfeaff' },
    cinderling:  { name: 'Cinderling',   glyph: '✦', color: '#ff9a3c', hp: 26, dmg: 13, speed: 3.4, range: 3.5, attackKind: 'ranged-soul', xp: 17, goldRange: [4, 9], trait: 'blink',    shape: 'imp',   projColor: '#ff9a3c' },
  ...
  const BESTIARY_LORE = {
    ...
    bonearcher:      'A skeleton that kept its aim. Splinters of bone fly true across the dark.',
    cryptooze:       'The crypts digest their dead slowly. This is what is left, and it is still hungry.',
    mossstalker:     'A predator wearing the forest as a coat. You hear the pack before you see it.',
    sporepod:        'A bobbing sac of spores that drifts close, then bursts in a stinging cloud.',
    rimecrawler:     'Frost-shelled and many-legged. It skitters over ice that would not hold you.',
    frostshade:      'Grief frozen solid. It slides through walls of ice to chill the breath from your lungs.',
    cinderling:      'A lesser cousin of the imp — quicker, hotter, gone before the flame lands.',
